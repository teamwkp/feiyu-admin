<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择状态" clearable size="small">
          <el-option
            v-for="dict in dict.type.system_an_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="announcementList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="内容" align="center" prop="mesage" />
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.system_an_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="内容">
          <editor v-model="form.mesage" :min-height="192"/>
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有系统公告数据项？').then(() => {
