  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="设备SN" prop="cabinetSn">
        <el-input
          v-model.trim="queryParams.cabinetSn"
          placeholder="请输入设备SN"
          clearable
          size="small"
      ...
      <el-form-item label="关键字">
        <el-input
          v-model.trim="queryParams.keyWorder"
          placeholder="请输入关键字"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="开始时间" prop="startTime">
        <el-time-picker
          ...
          :picker-options="{
            selectableRange:
              '00:00:00 - ' + (queryParams.endTime || '23:59:59'),
          }"
          style="width: 240px"
          placeholder="请选择开始时间"
        >
      ...
      <el-form-item label="结束时间" prop="endTime">
        <el-time-picker
          ...
          :picker-options="{
            selectableRange:
              (queryParams.startTime || '00:00:00') + ' - 23:59:59',
          }"
          style="width: 240px"
          placeholder="请选择结束时间"
        >
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除电池路由记录编号为"' + ids + '"的数据项？')
        .then(function () {
